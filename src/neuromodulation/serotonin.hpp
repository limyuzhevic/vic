...
public:
    ...
    // Cholinergic effects
    void enhanceWorkingMemory();
    void facilitateLearning();
    void strengthenAttention();
...
public:
    ...
    void setPredictionError(float error);
    
    // Dopamine-specific effects
    void modulateStdp(float reward);
    void enhanceMotivation();
    void encodeRewardPredictionError();
