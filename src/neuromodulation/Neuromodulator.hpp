...
public:
    ...
    // Facilitates attention focus and memory encoding
    void focusAttention(NeuronId neuron, float strength);
    void enhanceMemoryConsolidation(SimulationStep episodeAge);
...
public:
    ...
    // Increases arousal, vigilance, and signal detection
    void increaseArousal(float level);
    void enhanceSignalDetection(NeuronId neuron, float signalStrength);
    void reduceInhibition(float factor);
...
public:
    ...
    // Modulates mood, impulsivity, and social behavior
    void modulateMood(float moodLevel);
    void reduceImpulsivity(NeuronId neuron);
    void enhanceSocialBehavior(NeuronId neuron, float socialStrength);
