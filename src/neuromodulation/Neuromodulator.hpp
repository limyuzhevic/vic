...
public:
    ...
    // Higher values increase plasticity factor
...
public:
    ...
    // Arousal modulation for attention
    void increaseArousal();
    void enhanceAlertness();
...
public:
    ...
    void enhanceSocialLearning();
    void reduceImpulsivity();
