...
struct Brain::Impl {
    ...
    // Sensory neurons for input injection - FIXED: Use smart pointers to avoid memory leaks
    std::vector<std::unique_ptr<Neuron>> sensoryNeurons;
    std::vector<std::unique_ptr<Neuron>> motorNeurons;
