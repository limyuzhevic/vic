...
public:
    ...
    void setNeuromodulator(class Dopamine* dm) { neuromodulator_ = dm; }
    void setCuriosity(class Curiosity* cur) { curiosity_ = cur; }
    void setNovelty(class Novelty* nov) { novelty_ = nov; }
