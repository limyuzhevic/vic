...
PYBIND11_MODULE(pynlm, m) {
    ...
    py::class_<Neuron>(m, "Neuron", R"pbdoc(NLM neuron class)pbdoc")
        ...
        .def("getState", py::overload_cast(&Neuron::getState, py::const_))
        .def("getState", py::overload_cast(&Neuron::getState))
        .def("getPlasticityFlags", py::overload_cast(&Neuron::getPlasticityFlags, py::const_))
        .def("getPlasticityFlags", py::overload_cast(&Neuron::getPlasticityFlags))
        .def("enablePlasticity", &Neuron::enablePlasticity, py::arg("hebbian"), py::arg("stdp"), py::arg("rewardModulated"))
